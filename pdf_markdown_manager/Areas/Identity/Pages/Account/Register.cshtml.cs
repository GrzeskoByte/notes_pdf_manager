...
namespace pdf_markdown_manager.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    _logger.LogInformation("Now konto zostało utworzone");
                    ...
                    await _emailSender.SendEmailAsync(Input.Email, "Potwierdź swój email",
                        $"Proszę potwierdź swoje konto <a href='{HtmlEncoder.Default.Encode(callbackUrl)}'>KLIKAJAC TUTAJ</a>.");
